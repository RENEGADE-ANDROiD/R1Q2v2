...
Console / version string: **R1Q2v2 (Build: 8065)** — bump `BUILD` in [`build.h`](build.h) each release.
...
- **[RELEASE-NOTES-8063.md](RELEASE-NOTES-8063.md)** — Keep MP lean across map changes; avoid normalmap/playerskin hitch storms
